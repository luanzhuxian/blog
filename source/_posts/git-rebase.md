...
![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/merge-vs-reabse-1.png)

整合分支最容易的方法是`merge`命令：把两个分支的最新快照`C3`和`C4`，以及二者最近的共同祖先`C2`进行三方合并，合并的结果是生成一个新的快照。 

![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/merge-vs-reabse-2.png)
...
![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/merge-vs-reabse-3.png)

之后切回`master`进行合并。  

![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/merge-vs-reabse-4.png)
...
![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/start.png)
...
![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/merge.png)  
...
![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/after-rebase-before-merge.png)

4、切换到`master`分支，执行`git merge dev`，可以看到`HEAD`被置为`a73089d`。

![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/after-rebase-and-merge.png)

![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/after-rebase-and-merge-and-push.png)
...
![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/pull-rebase-1.png)

基于他人的提交变基，会将两边的新提交重新生成，生成一条直线。

![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/pull-rebase-2.png)

![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/pull-rebase-3.png)
...
![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/git-rebase_1.png)

现在我们在测试分支上添加了四次提交，我们的目标是把最后三个提交合并为一个提交：  

![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/git-rebase_2.png)
...
![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/git-rebase_3.png)
...
![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/git-rebase_4.png)

然后是注释修改界面：  

![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/git-rebase_5.png)
...
![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/git-rebase_6.png)
...
![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/git-rebase_7.png)

`develop`分支：  

![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/git-rebase_8.png)
...
![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/git-rebase_9.png)

可以看到，`C~E`部分的提交内容已经复制到了`G`的后面了。  
我们看一下当前分支的状态：  

![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/git-rebase_10.png)

当前`HEAD`处于游离状态，实际上，此时所有分支的状态应该是这样：  

![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/git-rebase_11.png)
...
![rebase](http://cdn.luanzhuxian.com/blog/git-rebase/git-rebase_12.png)
