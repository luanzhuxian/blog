...
![avatar](https://blog.luanzhuxian.com/blog/functional-programming_1.png)
```
  convertNames :: [String] -> [Object]
```
这里面涉及到一个 String -> Object 的转换，那我需要有这么个函数实现这种转换：

![avatar](https://blog.luanzhuxian.com/blog/functional-programming_2.png)
```
  convert2Obj :: [String] -> [Object]
```
至于这种转换，可以轻松想到需要两个函数完成：capitalizeName：把名称转换成指定形式，genObj：把任意类型转换成对象  

![avatar](https://blog.luanzhuxian.com/blog/functional-programming_3.png)
如果再细想一下，capitalizeName 其实也是几个方法的组合（split, join, capitalize），剩下的几个函数都是非常容易实现的。

![avatar](https://blog.luanzhuxian.com/blog/functional-programming_4.png)
代码实现：
```
...
![avatar](https://blog.luanzhuxian.com/blog/functional-programming_5.png)
...
![avatar](https://blog.luanzhuxian.com/blog/functional-programming_6.png)
...
非立即执行版
![avatar](https://blog.luanzhuxian.com/blog/debounce_1.png)
...
立即执行版
![avatar](https://blog.luanzhuxian.com/blog/debounce_2.png)
...
时间戳版
![avatar](https://blog.luanzhuxian.com/blog/throttle_1.png)
...
定时器版
![avatar](https://blog.luanzhuxian.com/blog/throttle_2.png)
