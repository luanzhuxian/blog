...
![avatar](http://cdn.luanzhuxian.com/blog/comment-view.png)
评论成功后，在相应的表里能看新插入的数据，可以删除编辑：
![avatar](http://cdn.luanzhuxian.com/blog/comment-data.png)
...
![avatar](http://cdn.luanzhuxian.com/blog/comment_1.png)

那么打开浏览器调试工具看看这个标签的类名是不是包含`valine-comment-count`：

![avatar](http://cdn.luanzhuxian.com/blog/comment_2.png)
...
![avatar](http://cdn.luanzhuxian.com/blog/comment_3.png)

# 头像配置
参考 **[Valine 评论系统中的头像配置](https://valine.js.org/avatar.html)**  

上面`valine > avatar`字段用来设置评论头像，可选值如下:
![avatar](http://cdn.luanzhuxian.com/blog/comment-avatar_1.png)
之后注册登录[Gravatar](https://cn.gravatar.com)，并设置头像
![avatar](http://cdn.luanzhuxian.com/blog/comment-avatar_2.png)
...
```
刷新头像变成自定义的了：
![avatar](http://cdn.luanzhuxian.com/blog/comment-avatar_3.png)
...
![avatar](http://cdn.luanzhuxian.com/blog/comment-notify_1.png)
...
![avatar](http://cdn.luanzhuxian.com/blog/comment-notify_2.png)
