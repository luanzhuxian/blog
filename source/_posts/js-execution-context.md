...
![avatar](http://cdn.luanzhuxian.com/blog/execution-context_4.gif)
...
![avatar](http://cdn.luanzhuxian.com/blog/execution-context_5.gif)

我们来改写之前的代码，让函数拥有局部变量。
![avatar](http://cdn.luanzhuxian.com/blog/execution-context_6.gif)
这里有几处重要细节需要注意。  
...
![avatar](http://cdn.luanzhuxian.com/blog/execution-context_11.jpg)
...
![avatar](http://cdn.luanzhuxian.com/blog/execution-context_12.jpg)
...
![avatar](http://cdn.luanzhuxian.com/blog/execution-context_13.png)
...
```
  ...
  logName()
```
![avatar](http://cdn.luanzhuxian.com/blog/execution-context_9.gif)
...
```
  ...
  count += add5(2) // 7
```
![avatar](http://cdn.luanzhuxian.com/blog/execution-context_10.gif)
...
```
  ...
  console.log(bar)
```
![avatar](http://cdn.luanzhuxian.com/blog/execution-context_7.gif)
...
```
  ...
  console.log(name)
```
![avatar](http://cdn.luanzhuxian.com/blog/execution-context_8.gif)
