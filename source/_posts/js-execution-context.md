---
title: JavaScript 中的执行上下文、执行栈和作用域
comments: true
...
![avatar](http://pqg06rxde.bkt.clouddn.com/blog/execution-context_1.png)
让我们看看添加了代码会怎么样：
![avatar](http://pqg06rxde.bkt.clouddn.com/blog/execution-context_2.png)
![avatar](http://pqg06rxde.bkt.clouddn.com/blog/execution-context_3.png)
...
![avatar](http://pqg06rxde.bkt.clouddn.com/blog/execution-context_4.gif)
...
![avatar](http://pqg06rxde.bkt.clouddn.com/blog/execution-context_5.gif)

我们来改写之前的代码，让函数拥有局部变量。
![avatar](http://pqg06rxde.bkt.clouddn.com/execution-context_6.gif)
这里有几处重要细节需要注意。  
...
```
  ...
  console.log(bar)
```
![avatar](http://pqg06rxde.bkt.clouddn.com/blog/execution-context_7.gif)
...
```
  ...
  console.log(name)
```
![avatar](http://pqg06rxde.bkt.clouddn.com/blog/execution-context_8.gif)
...
```
  ...
  logName()
```
![avatar](http://pqg06rxde.bkt.clouddn.com/blog/execution-context_9.gif)
...
```
  ...
  count += add5(2) // 7
```
![avatar](http://pqg06rxde.bkt.clouddn.com/blog/execution-context_10.gif)
