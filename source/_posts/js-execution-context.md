...
![avatar](https://blog.luanzhuxian.com/blog/execution-context_1.png)
让我们看看添加了代码会怎么样：
![avatar](https://blog.luanzhuxian.com/blog/execution-context_2.png)
![avatar](https://blog.luanzhuxian.com/blog/execution-context_3.png)
...
![avatar](https://blog.luanzhuxian.com/blog/execution-context_4.gif)
...
![avatar](https://blog.luanzhuxian.com/blog/execution-context_5.gif)

我们来改写之前的代码，让函数拥有局部变量。
![avatar](https://blog.luanzhuxian.com/blog/execution-context_6.gif)
这里有几处重要细节需要注意。  
...
```
  ...
  count += add5(2) // 7
```
![avatar](https://blog.luanzhuxian.com/blog/execution-context_10.gif)
...
```
  ...
  console.log(bar)
```
![avatar](https://blog.luanzhuxian.com/blog/execution-context_7.gif)
...
```
  ...
  console.log(name)
```
![avatar](https://blog.luanzhuxian.com/blog/execution-context_8.gif)
